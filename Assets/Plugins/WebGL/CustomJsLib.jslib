mergeInto(LibraryManager.library, {
  ...
  RegisterVisibilityChangeListener: function (gameObjectNamePtr) {
    ...
    console.log(
      "[JS] RegisterVisibilityChangeListener called for GameObject:",
      gameObjectName,
    );
      ...
      try {
        var wa =
          typeof WEBAudio !== "undefined"
            ? WEBAudio
            : typeof Module !== "undefined" && Module.WEBAudio
              ? Module.WEBAudio
              : null;
    ...
    console.log(
      "[JS] Visibility/focus event listeners registered for:",
      gameObjectName,
    );
  },
